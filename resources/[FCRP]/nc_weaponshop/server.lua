...
RegisterNetEvent('CK:WEAPONSHOP:TryToBuy')
AddEventHandler('CK:WEAPONSHOP:TryToBuy', function(shopId, itemId)
    ...
    TriggerClientEvent('CK:WEAPONSHOP:BuyingAnimation', _source, itemId)
end)
