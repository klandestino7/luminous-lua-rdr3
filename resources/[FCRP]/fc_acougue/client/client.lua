...
function GetHashName(hash)
  ...
  if carriedEntity then
        ...
        if carriedEntityHash then
            ...
            TxtAtWorldCoord(pCoords.x, pCoords.y, pCoords.z - 0.7, "Carrying: " .. carriedEntityHash .. " | " .. ( or ""), 0.175, 1)
        end
    end ]]
            ...
            if Vdist(coords, v) < 3 then
                ...
                if IsControlJustReleased(0, keys['E']) then
                    ...
                    if carried and itemmao then
                        ...
                        NetworkRequestControlOfEntity(carried)
                        local timeout = 0
                        while not NetworkHasControlOfEntity(carried) and timeout < 5000 do
                            timeout = timeout+100
                            if timeout == 5000 then
                                print('Never got control of' .. carried)
                            end
                            Wait(100)
                        end
                        DeleteEntity(carried)
                        TriggerServerEvent('fc_acougue:addmoneyskin', carried)
                    end
                    ...
                    if holding >= 1 then
                        ...
                        DeleteEntity(carried)
                        TriggerServerEvent('fc_acougue:addmoneymeat', carried)
                    end
                end
            end
        end
                    ...
                    if model == -2011226991 then  -- eastern wild turkey black
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                TriggerServerEvent("fc_acougue:addmoney", 0.75, model)
                    ...
                    elseif model == 1458540991 then  -- Racoon
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "game"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", 1, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == 90267823 then  -- Cougar
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "biggame"
                                local meatamount = 2
                                TriggerServerEvent("fc_acougue:addmoney", 1.5, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == 1110710183 then  -- whitetail deer
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "venison"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", 2.5, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == -1414989025 then  -- virginia opossum
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "stringy"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", price, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == -1170118274 then  -- American Badger
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "stringy"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", 0.5, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == -8651544272 then  -- Great Horned Owl
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "bird"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", 1.50, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == -885451903 then  -- Timber Wolf
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "biggame"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", 2, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == 252669332 then  -- American Red Fox
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "game"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", 1.25, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == 1007418994 then  -- Berkshire Pig
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "pork"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", 0.25, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == -300867788 then  -- Lake Sturgeon
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "fish"
                                local meatamount = 2
                                TriggerServerEvent("fc_acougue:addmoney", 2.45, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == 90264823 then  -- Cougar 
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "biggame"
                                local meatamount = 1
                                TriggerServerEvent("fc_acougue:addmoney", 3.75, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                    ...
                    elseif model == 1095117488 then  -- Tricolored Heron
                        ...
                        Wait(500)
                            ...
                            if holding == 0 then
                                ...
                                local item = "bird"
                                local meatamount = 2
                                TriggerServerEvent("fc_acougue:addmoney", 1.75, model)
                                --TriggerServerEvent("gunshop:giveitem", item, meatamount)
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold carcass")
                                --TriggerEvent("redemrp_notification:start", "You earned $" .. price .. " and " .. meatamount .. ' ' .. item .. " meat", 5, "success")
                ...
                --pelts
                    ...
                    if HASH_PROVISIONS[carriedEntityHash] == "PROVISION_DEER_HIDE_POOR" then --whitetail deer Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 0.5, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_DEER_HIDE" then --whitetail deer Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 0.75, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_DEER_HIDE_PRISTINE" then --whitetail deer Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 1, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_BOAR_SKIN_POOR" then --Wild Boar Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 2, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_BOAR_SKIN" then --Wild Boar Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 2.5, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_BOAR_SKIN_PRISTINE" then --Wild Boar Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 3, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_PIG_SKIN_POOR" then --Pig Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 0.05, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_PIG_SKIN" then --Pig Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 0.15, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_PIG_SKIN_PRISTINE" then --Pig Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 0.25, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_RAM_HIDE_POOR" then --Ram Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 1.0, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_RAM_HIDE" then --Ram Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 1.25, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_RAM_HIDE_PRISTINE" then --Ram Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 1.5, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_BEAR_FUR_PRISTINE" then  -- Grizzly Bear pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 4, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_BUFFALO_FUR_PRISTINE" then  -- Grizzly Bear pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 5, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_BLACK_BEAR_FUR_PRISTINE" then  -- Alligator Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 3.5, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_COYOTE_FUR_PRISTINE" then  -- Alligator Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 1.75, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_PANTHER_FUR_POOR" then  -- Alligator Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 2.15, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_PANTHER_FUR" then  -- Alligator Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 2.25, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
                    ...
                    elseif HASH_PROVISIONS[carriedEntityHash] == "PROVISION_JAVELINA_SKIN_POOR" then  -- Alligator Pelt
                        ...
                        Wait(500)
                            ...
                            local holding = GetPedType(entitycheck)
                            if holding == 0 then
                                TriggerServerEvent("fc_acougue:addmoney", 1.15, HASH_PROVISIONS[carriedEntityHash])
                                TriggerServerEvent('fcxp:systemxp', tonumber(2))
                                print("sold Hide")
                            end
