...
RegisterNetEvent('FCRP:WEAPONSHOP:BuyWeapon')
AddEventHandler('FCRP:WEAPONSHOP:BuyWeapon', function(id)
    ...
    local weapon = weapons[id][1]
    local price = weapons[id][2]

    local ItemData = API.getItemDataFromId(weapon)
...
RegisterNetEvent('FCRP:WEAPONSHOP:BuyAmmo')
AddEventHandler('FCRP:WEAPONSHOP:BuyAmmo', function(id)
