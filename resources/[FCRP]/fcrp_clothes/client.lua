...
RegisterNUICallback(
    ...
    function(data)
        ...
        if tonumber(data.id) == 0 then
            num = nil
            BootsUsing = num
            Citizen.InvokeNative(0xD3A7B003ED343FD9, PlayerPedId(),tonumber(0),true,true,true)
          --  Citizen.InvokeNative(0xD710A5007C2AC539, PlayerPedId(), 0x1D4C528A, 0) -- Set target category
...
RegisterNUICallback(
    ...
    function()
        ...
        TriggerServerEvent('fcrp_clothes:saveCloth', dados)
        closeAll()
    end
)
