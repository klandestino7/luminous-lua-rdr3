...
RegisterNetEvent('fcrp_creator:createCharacter')
AddEventHandler('fcrp_creator:createCharacter', function()
...
RegisterNUICallback('FinishedCreator', function(data)
    ...
    TriggerServerEvent('fcrp_creator:saveCreator', data.charName, data.age, sendAll, clothes)
