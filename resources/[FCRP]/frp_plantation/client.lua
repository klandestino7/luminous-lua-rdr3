RegisterNetEvent("FCRP:PLANTATION:StartPlayerPlacement")
RegisterNetEvent("FCRP:PLANTATION:SyncPlant")
RegisterNetEvent("FCRP:PLANTATION:SyncMultiplePlants")

AddEventHandler(
    "FCRP:PLANTATION:StartPlayerPlacement",
    function(source, type)
        print("FCRP:PLANTATION:StartPlayerPlacement")
...
AddEventHandler(
    "FCRP:PLANTATION:SyncMultiplePlants",
    function(array)
...
function drawTempEntity()
    if tempEntity ~= nil then
        ...
        if Citizen.InvokeNative(0x50F940259D3841E6, 1, 0x07CE1E61) then -- LMB
            ...
            TriggerServerEvent("FCRP:PLANTATION:EndPlayerPlacement", tempType, x, y, z, h)
        ...
        if Citizen.InvokeNative(0x50F940259D3841E6, 1, 0xF84FA74F) then -- RMB
            ...
            tempEntity = nil
            tempType = nil
            TriggerServerEvent("FCRP:PLANTATION:EndPlayerPlacement", nil, nil, nil, nil, nil)
        end
    end
end
            ...
            if closestPlantId ~= nil then
                ...
                if dist > 1.5 then
                    ...
                    if IsControlJustPressed(2, 0xCEFD9220) then -- E
                        TriggerServerEvent("FCRP:PLANTATION:Open", closestPlantId)
                    end
                end
            end
...
Citizen.CreateThreadNow(
    function()
        TriggerServerEvent("FCRP:PLANTATION:AskForSync")
    end
)
