...
--         -- Citizen.InvokeNative(0x15598CFB25F3DC7E , animScene, "pl_IG3_ENTER_TO_POINT_A", true)
...
--         TaskEnterAnimScene(PlayerPedId(), animScene, "Jack", "pl_IG3_ENTER_TO_POINT_A", 1.0, false, 1, 20000, -1082130432)
--     end,
--     false
-- )
