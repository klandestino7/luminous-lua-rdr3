...
RegisterNetEvent('VP:PLANTATION:AskForSync')
RegisterNetEvent('VP:PLANTATION:StartPlayerPlacement')
RegisterNetEvent('VP:PLANTATION:EndPlayerPlacement')
RegisterNetEvent('VP:PLANTATION:Open')

AddEventHandler(
    'VP:PLANTATION:AskForSync',
    function()
...
AddEventHandler(
    ...
    function(source, capacity)
        ...
        TriggerClientEvent('VP:PLANTATION:StartPlayerPlacement', _source, capacity)
    end
)

AddEventHandler(
    'VP:PLANTATION:EndPlayerPlacement',
...
AddEventHandler(
    ...
    function(name, setReason)
        local _source = source
        TriggerClientEvent('VP:PLANTATION:SyncMultipleChests', _source, tempChests)
    end
)
