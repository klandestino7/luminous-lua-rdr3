		...
		while true do
			...
			if isInjure then
				...
				if up then
					...
					Citizen.InvokeNative(0xCB9401F918CB0F75, PlayerPedId(), "IsDrunk", 1, -1)
					Citizen.InvokeNative(0x437C08DB4FEBE2BD, PlayerPedId(), "Drunkness", 1.0, -1)

					Wait(AliveTime)

					Citizen.InvokeNative(0x406CCF555B04FAD3, PlayerPedId(), 0, 0.0)
					Citizen.InvokeNative(0xCB9401F918CB0F75, PlayerPedId(), "IsDrunk", 0, -1)
					Citizen.InvokeNative(0x437C08DB4FEBE2BD, PlayerPedId(), "Drunkness", 0.0, -1)
