...
AddEventHandler('VP:BANKING:sendmoney', function(player, amount, nome)
...
RegisterNUICallback('deposit', function(data)
	TriggerServerEvent('VP:BANKING:deposit', tonumber(data.amount))
end)
...
RegisterNUICallback('withdrawl', function(data)
	TriggerServerEvent('VP:BANKING:withdraw', tonumber(data.amountw))	
end)
