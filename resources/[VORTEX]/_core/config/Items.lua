ItemList = {
    ...
    ['thrown_bolas'] = {
        ...
        name = 'Boleadeira',
        weight = 2.5,
        description = 'Um conjunto de bolas pesadas acorrentadas, que quando lançado a um inimigo, o prende no mesmo instante.',
        stackSize = 3,
    },
    ['bolas'] = {
        type = 'weapon',
    ...
    ['copper_bar'] = {
        ...
        name = 'Barra de Cobre',
        weight = 1.5,
        description = 'Uma barra de cobre enegrecida, talvez tenha algum valor.',
        stackSize = 20,
    },
    ['potassio'] = {
        type = 'generic',
