...
AddEventHandler('frp_weaponshop:sendShop', function(shopItems)
...
AddEventHandler('frp_weaponshop:hasEnteredMarker', function(zone)
...
AddEventHandler('frp_weaponshop:hasExitedMarker', function(zone)
    CurrentAction = nil
...
RegisterNUICallback('buyItem', function(data, cb)    
    TriggerServerEvent('FC:WEAPONSHOP:BuyWeapon', data)
end) 
