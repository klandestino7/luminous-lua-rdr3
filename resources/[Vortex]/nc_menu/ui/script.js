$(document).ready(function(){
  ...
  $('.openCoffre').on('click', function(e){
    e.preventDefault();
    $.post('http://nc_menu/togglecoffre', JSON.stringify({
      id: idEnt
    }));
  ...
  $('.openCapot').on('click', function(e){
    e.preventDefault();
    $.post('http://nc_menu/togglecapot', JSON.stringify({
      id: idEnt
    }));
  ...
  $('.lock').on('click', function(e){
    e.preventDefault();
    $.post('http://nc_menu/togglelock', JSON.stringify({
      id: idEnt
    }));
  ...
  $('.cheer').on('click', function(e){
    e.preventDefault();
    $.post('http://nc_menu/cheer', JSON.stringify({
      id: idEnt
    }));
  });
  ...
  $('.crosshair').on('click', function(e){
    ...
    $(".menu").removeClass('fadeIn');
    $.post('http://nc_menu/disablenuifocus', JSON.stringify({
      nuifocus: false
    }));
  });
