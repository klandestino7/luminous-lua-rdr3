...
------------EXAMPLE------------------------
--	  local timer = 5 
--    local text = "Simple test frp_notify2"
--    TriggerEvent("frp_notify2:start", text, timer)
--------------OR-------------------------

--    TriggerEvent("frp_notify2:start", "Simple test frp_notify2" , 5)
...
RegisterNetEvent('frp_notify2:start')
AddEventHandler('frp_notify2:start',  function(_text, _timer)
    if active then
        active = false
        hideUI()
    else
