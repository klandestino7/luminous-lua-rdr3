...
AddEventHandler('VP:SHERIFF:PoliceCheck', function(police)
	PoliceCheck = police	
end)

RegisterNetEvent('VP:SHERIFF:SheriffCheck')
AddEventHandler('VP:SHERIFF:SheriffCheck', function(sheriff)
...
AddEventHandler('VP:SHERIFF:giveweapon', function(weapon)
    Citizen.CreateThread(function()
...
AddEventHandler('VP:SHERIFF:unrestrain', function()
	if Handcuffed then
		local playerPed = PlayerPedId()		
		Handcuffed = false
...
AddEventHandler('VP:SHERIFF:putinvehicle', function()	
...
AddEventHandler('VP:SHERIFF:vehiclep', function()
...
AddEventHandler('VP:SHERIFF:outvehicle', function()	
...
AddEventHandler('VP:SHERIFF:vehicleout', function()
	local playerPed = PlayerPedId()
...
AddEventHandler('VP:SHERIFF:cuff', function()
    ped = GetPlayerPed(-1)
	ped2 = PlayerPedId()
...
AddEventHandler('VP:SHERIFF:uncuff', function()
    ped = GetPlayerPed(-1)
    ped2 = PlayerPedId()  
	ClearPedTasks(ped)
...
AddEventHandler('VP:SHERIFF:cuffcheck', function()
  local player, distance = GetClosestPlayer()
  if distance ~= -1 and distance <= 3.0 then   
...
AddEventHandler('VP:SHERIFF:nyckelcheck', function()    
...
AddEventHandler('VP:SHERIFF:unlockingcuffs', function()
  local player, distance = GetClosestPlayer()
