...
--	{name = "Aluguel de Barcos", sprite = 2033397166, x = -686.16, y = -1243.67, z = 43.1},
	{name = "Aluguel de Barcos", sprite = 2033397166, x = 2883.17, y = -1354.51, z = 42.61}, -- saint dennis
	{name = "Aluguel de Barcos", sprite = 2033397166, x = 3030.43, y = 553.86, z = 44.71}, -- van horn	
	
	-- PRISÃO FEDERAL	
	{name = "Prisão Federal", sprite = 1047294027, x = 3372.48, y = -667.09, z = 46.41},
